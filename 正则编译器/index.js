class Mark {
    ...
    constructor() {
        //dom容器
        this.codeContainer = document.getElementById('code');
        this.lineContainer = document.getElementById('line');
        this.showContainer = document.getElementById('show');
        this._line = this.lineContainer.children.length;
        this.show = document.createDocumentFragment();
        this.init = true;
        //列表容器
        this.list = {
            type: undefined,
